  		...
  		if(isChecked){
  			...
  			$.ajax({
 				...
 				data : {
 					...
 					'reported_member_id' : "${dto.comment_writer }",
 					'reported_contents' : "${dto.comment_contents }",
 					'reporter' : "${member_id }",
...
<div id="form-wrap">
	<br>
	<div id="writer">작성자  | ${dto.comment_writer}</div>
	<div id="contents"> 제목/내용  | ${dto.comment_contents }</div>
	<p>신고하시는 사유를 선택해주세요.</p>
	<form action="reportComment" id="reportComment" method="post">
		<div>
